...
const defaultMaxCompletionTokens = ref(8192);
const defaultTemperature = ref(0.5);
...
const defaultFormData = {
  ...
  config: {
    ...
    // 模型设置
    model_id: '6c374d78-275a-48c1-aa5d-311afe1e774e',
    rerank_model_id: 'c2923749-32c3-4467-9d88-ec5c573cb6cf',
    temperature: 0.5,
...
const fillBuiltinAgentDefaults = () => {
  ...
  // 🔧 新增：如果 model_id 为空，则设置默认模型 ID
  if (!config.model_id) {
    config.model_id = '6c374d78-275a-48c1-aa5d-311afe1e774e';
    config.rerank_model_id = 'c2923749-32c3-4467-9d88-ec5c573cb6cf';
